...
var smsUrl =
  "https://smsapp.mx9.in/smpp/?username=numetryindia&password=9790944889&from=NUMETRYS&to=91";

const BUCKET_NAME = "numetryindia";
    ...
    Online.findOneAndUpdate(
      ...
      function(err, online) {
        ...
        if (body.txStatus === "SUCCESS") {
          res.writeHead(301, {
            Location: "http://www.numetryindia.com/payment-success/"
          });
          return res.end();
        }
        res.writeHead(301, {
          Location: "http://www.numetryindia.com/payment-failure/"
        });
        return res.end();
      }
    );
...
//   });
  var otp = '0000';
  var messageData =
    "Greetings from Numetry. Your One Time Password (OTP) is " +
    otp +
...
createCheksum = function(online) {
  ...
  var postData = {
    ...
    returnUrl: "https://numetry-server.herokuapp.com/api/online/payments",
    notifyUrl: "https://numetry-server.herokuapp.com/api/online/payments"
  };
